...
pub mod monitoring_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Gets the health status of the database."]
        pub async fn self_check(
            &mut self,
            request: impl tonic::IntoRequest<super::super::SelfCheckRequest>,
        ) -> Result<tonic::Response<super::super::SelfCheckResponse>, tonic::Status> {
