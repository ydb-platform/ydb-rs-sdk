...
pub struct StreamingWriteClientMessage {
    #[prost(
        oneof = "streaming_write_client_message::ClientMessage",
        tags = "1, 2, 3"
    )]
...
pub mod streaming_write_client_message {
    ...
    pub struct InitRequest {
        ...
        pub session_meta: ::std::collections::HashMap<
...
pub struct StreamingWriteServerMessage {
    ...
    #[prost(
        oneof = "streaming_write_server_message::ServerMessage",
        tags = "3, 4, 5"
    )]
...
pub struct StreamingReadClientMessageNew {
    ...
    pub token: ::prost::alloc::string::String,
    #[prost(
        oneof = "streaming_read_client_message_new::ClientMessage",
...
pub struct StreamingReadServerMessageNew {
    ...
    pub issues: ::prost::alloc::vec::Vec<super::super::issue::IssueMessage>,
    #[prost(
        oneof = "streaming_read_server_message_new::ServerMessage",
...
pub mod streaming_read_server_message_new {
    ...
    pub struct InitResponse {
        ...
        pub block_format_version_by_topic:
    ...
    pub struct CommitResponse {
        ...
        pub partitions_committed_offsets:
            ::prost::alloc::vec::Vec<commit_response::PartitionCommittedOffset>,
    }
...
pub struct MigrationStreamingReadClientMessage {
    ...
    #[prost(
        oneof = "migration_streaming_read_client_message::Request",
        tags = "1, 2, 3, 4, 5, 6"
    )]
...
pub struct MigrationStreamingReadServerMessage {
    ...
    pub issues: ::prost::alloc::vec::Vec<super::super::issue::IssueMessage>,
    #[prost(
        oneof = "migration_streaming_read_server_message::Response",
        tags = "3, 4, 5, 6, 7, 8"
    )]
...
pub mod read_info_result {
    ...
    pub mod topic_info {
        ...
        pub struct PartitionInfo {
            ...
            #[prost(
                enumeration = "super::super::super::super::status_ids::StatusCode",
                tag = "2"
            )]
            pub status: i32,
            /// Issues if any.
