...
use super::sender::{StreamReadCommand, TopicSender};
...
impl MockTopicService {
    pub fn new(to_server: FromServiceToServerTx, rx: TopicRx) -> Self {
        ...
        tokio::spawn(Self::handle_messages(topic_sender.clone(), rx));
    ...
    async fn handle_messages(topic_sender: TopicSender, mut rx: TopicRx) {
