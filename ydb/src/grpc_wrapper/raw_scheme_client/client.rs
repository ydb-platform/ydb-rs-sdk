...
impl RawSchemeClient {
    ...
    #[instrument(name = "ydb.grpc.ListDirectory", skip_all, fields(db.system.name = "ydb", ydb.path = %req.path), err)]
    ...
    #[instrument(name = "ydb.grpc.MakeDirectory", skip_all, fields(db.system.name = "ydb", ydb.path = %req.path), err)]
    ...
    #[instrument(name = "ydb.grpc.RemoveDirectory", skip_all, fields(db.system.name = "ydb", ydb.path = %req.path), err)]
    ...
    #[instrument(name = "ydb.grpc.DescribePath", skip_all, fields(db.system.name = "ydb", ydb.path = %req.path), err)]
