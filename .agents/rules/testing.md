...
CI also runs `cargo test --workspace --doc` and `cargo test --workspace -- --include-ignored` against `ydbplatform/local-ydb:nightly` on Rust 1.88 and pinned Rust 1.96.
