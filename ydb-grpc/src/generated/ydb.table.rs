    ...
    impl State {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::Preparing => "STATE_PREPARING",
                Self::TransferingData => "STATE_TRANSFERING_DATA",
                Self::Applying => "STATE_APPLYING",
                Self::Done => "STATE_DONE",
                Self::Cancellation => "STATE_CANCELLATION",
                Self::Cancelled => "STATE_CANCELLED",
                Self::Rejection => "STATE_REJECTION",
    ...
    impl Mode {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::KeysOnly => "MODE_KEYS_ONLY",
                Self::Updates => "MODE_UPDATES",
                Self::NewImage => "MODE_NEW_IMAGE",
                Self::OldImage => "MODE_OLD_IMAGE",
                Self::NewAndOldImages => "MODE_NEW_AND_OLD_IMAGES",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
    ...
    impl Format {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::DynamodbStreamsJson => "FORMAT_DYNAMODB_STREAMS_JSON",
...
pub mod changefeed_description {
    ...
    impl State {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                Self::Unspecified => "STATE_UNSPECIFIED",
                Self::Enabled => "STATE_ENABLED",
                Self::Disabled => "STATE_DISABLED",
                Self::InitialScan => "STATE_INITIAL_SCAN",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub mod partitioning_policy {
    ...
    impl AutoPartitioningPolicy {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                Self::Unspecified => "AUTO_PARTITIONING_POLICY_UNSPECIFIED",
                Self::Disabled => "DISABLED",
                Self::AutoSplit => "AUTO_SPLIT",
                Self::AutoSplitMerge => "AUTO_SPLIT_MERGE",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub mod query_stats_collection {
    ...
    impl Mode {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                Self::StatsCollectionUnspecified => "STATS_COLLECTION_UNSPECIFIED",
                Self::StatsCollectionNone => "STATS_COLLECTION_NONE",
                Self::StatsCollectionBasic => "STATS_COLLECTION_BASIC",
                Self::StatsCollectionFull => "STATS_COLLECTION_FULL",
                Self::StatsCollectionProfile => "STATS_COLLECTION_PROFILE",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl StoreType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::Row => "STORE_TYPE_ROW",
            Self::Column => "STORE_TYPE_COLUMN",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
