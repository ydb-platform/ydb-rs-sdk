...
pub mod discovery_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn who_am_i(
            ...
            tonic::Response<super::super::WhoAmIResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
pub mod discovery_service_server {
    ...
    pub trait DiscoveryService: std::marker::Send + std::marker::Sync + 'static {
        async fn list_endpoints(
            &self,
            request: tonic::Request<super::super::ListEndpointsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::ListEndpointsResponse>,
            tonic::Status,
        >;
        async fn who_am_i(
            &self,
            request: tonic::Request<super::super::WhoAmIRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::WhoAmIResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/Ydb.Discovery.V1.DiscoveryService/ListEndpoints" => {
                    ...
                    struct ListEndpointsSvc<T: DiscoveryService>(pub Arc<T>);
                    impl<
                        T: DiscoveryService,
                    > tonic::server::UnaryService<super::super::ListEndpointsRequest>
                    for ListEndpointsSvc<T> {
                        type Response = super::super::ListEndpointsResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as DiscoveryService>::list_endpoints(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/Ydb.Discovery.V1.DiscoveryService/WhoAmI" => {
                    #[allow(non_camel_case_types)]
                    struct WhoAmISvc<T: DiscoveryService>(pub Arc<T>);
                    impl<
                        T: DiscoveryService,
                    > tonic::server::UnaryService<super::super::WhoAmIRequest>
                    for WhoAmISvc<T> {
                        type Response = super::super::WhoAmIResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DiscoveryService>::who_am_i(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "Ydb.Discovery.V1.DiscoveryService";
