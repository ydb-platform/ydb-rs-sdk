...
pub mod auth_service_server {
    ...
    pub trait AuthService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn login(
            &self,
            request: tonic::Request<super::super::LoginRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::LoginResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/Ydb.Auth.V1.AuthService/Login" => {
                    ...
                    impl<
                        T: AuthService,
                    > tonic::server::UnaryService<super::super::LoginRequest>
                    for LoginSvc<T> {
                        type Response = super::super::LoginResponse;
    ...
    pub const SERVICE_NAME: &str = "Ydb.Auth.V1.AuthService";
