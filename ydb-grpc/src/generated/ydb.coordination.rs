...
impl ConsistencyMode {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unset => "CONSISTENCY_MODE_UNSET",
            Self::Strict => "CONSISTENCY_MODE_STRICT",
            Self::Relaxed => "CONSISTENCY_MODE_RELAXED",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "CONSISTENCY_MODE_UNSET" => Some(Self::Unset),
            "CONSISTENCY_MODE_STRICT" => Some(Self::Strict),
            "CONSISTENCY_MODE_RELAXED" => Some(Self::Relaxed),
            _ => None,
        }
    }
}
...
impl RateLimiterCountersMode {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unset => "RATE_LIMITER_COUNTERS_MODE_UNSET",
            Self::Aggregated => "RATE_LIMITER_COUNTERS_MODE_AGGREGATED",
            Self::Detailed => "RATE_LIMITER_COUNTERS_MODE_DETAILED",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "RATE_LIMITER_COUNTERS_MODE_UNSET" => Some(Self::Unset),
            "RATE_LIMITER_COUNTERS_MODE_AGGREGATED" => Some(Self::Aggregated),
            "RATE_LIMITER_COUNTERS_MODE_DETAILED" => Some(Self::Detailed),
            _ => None,
        }
    }
}